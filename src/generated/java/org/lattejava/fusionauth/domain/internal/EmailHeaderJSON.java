...
import org.lattejava.fusionauth.domain.EmailHeader;
 ...
 * @author Latte JSON
 */
public final class EmailHeaderJSON implements JSONObserver<EmailHeader> {
  private String name;
  private String value;
  public static String toJSON(EmailHeader value) {
    return builder(value).build();
  }

  public static byte[] toJSONBytes(EmailHeader value) {
    return builder(value).buildBytes();
  }

  private static JSONBuilder builder(EmailHeader value) {
  ...
  public static EmailHeader fromJSON(String json) {
    var observer = new EmailHeaderJSON();
    return new JSONParser().parse(json, observer);
  }

  public static EmailHeader fromJSON(byte[] json) {
    var observer = new EmailHeaderJSON();
    return new JSONParser().parse(json, observer);
  }
  ...
  @Override public EmailHeader finish() {
