...
import org.lattejava.fusionauth.domain.FIPS;
 ...
 * @author Latte JSON
 */
public final class FIPSJSON implements JSONObserver<FIPS> {
  public static String toJSON(FIPS value) {
    return builder(value).build();
  }

  public static byte[] toJSONBytes(FIPS value) {
    return builder(value).buildBytes();
  }

  private static JSONBuilder builder(FIPS value) {
  ...
  public static FIPS fromJSON(String json) {
    var observer = new FIPSJSON();
    return new JSONParser().parse(json, observer);
  }

  public static FIPS fromJSON(byte[] json) {
    var observer = new FIPSJSON();
    return new JSONParser().parse(json, observer);
  }
