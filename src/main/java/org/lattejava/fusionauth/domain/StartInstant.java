...
public record StartInstant(
    Map<String, ZonedDateTime> applications,
  ...
  public static final class Builder {
    private Map<String, ZonedDateTime> applications;
    private Instant tenant;
    public Builder applications(Map<String, ZonedDateTime> applications) { this.applications = applications; return this; }
