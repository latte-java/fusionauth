...
import org.lattejava.fusionauth.domain.internal.VoiceMessageTemplateJSON;

@JSON
public record VoiceMessageTemplate(
  ...
  public static final class Builder {
    ...
    public VoiceMessageTemplate build() { return new VoiceMessageTemplate(defaultTemplate, localizedTemplates, data, id, insertInstant, lastUpdateInstant, name, type); }
  }
}
