...
import org.lattejava.fusionauth.domain.internal.SonyPSNIdentityProviderJSON;

@JSON
@JSONSubtype("SonyPSN")
public record SonyPSNIdentityProvider(
    String buttonText,
    String client_id,
    String client_secret,
    String scope,
    Map<String, Object> data,
    Map<String, SonyPSNApplicationConfiguration> applicationConfiguration,
  ...
  public static final class Builder {
    ...
    private Map<String, SonyPSNApplicationConfiguration> applicationConfiguration;
    ...
    public Builder applicationConfiguration(Map<String, SonyPSNApplicationConfiguration> applicationConfiguration) { this.applicationConfiguration = applicationConfiguration; return this; }
    ...
    public SonyPSNIdentityProvider build() { return new SonyPSNIdentityProvider(buttonText, client_id, client_secret, scope, data, applicationConfiguration, attributeMappings, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantConfiguration, tenantId); }
  }
}
