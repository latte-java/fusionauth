...
import org.lattejava.fusionauth.domain.internal.LinkedInIdentityProviderJSON;

@JSON
@JSONSubtype("LinkedIn")
public record LinkedInIdentityProvider(
    String buttonText,
    String client_id,
    String client_secret,
    String scope,
    Map<String, Object> data,
    Map<String, LinkedInApplicationConfiguration> applicationConfiguration,
  ...
  public static final class Builder {
    ...
    private Map<String, LinkedInApplicationConfiguration> applicationConfiguration;
    ...
    public Builder applicationConfiguration(Map<String, LinkedInApplicationConfiguration> applicationConfiguration) { this.applicationConfiguration = applicationConfiguration; return this; }
    ...
    public LinkedInIdentityProvider build() { return new LinkedInIdentityProvider(buttonText, client_id, client_secret, scope, data, applicationConfiguration, attributeMappings, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantConfiguration, tenantId); }
  }
}
