...
import org.lattejava.fusionauth.domain.internal.SteamIdentityProviderJSON;

@JSON
@JSONSubtype("Steam")
public record SteamIdentityProvider(
    ...
    Map<String, SteamApplicationConfiguration> applicationConfiguration,
  ...
  public static final class Builder {
    ...
    private Map<String, SteamApplicationConfiguration> applicationConfiguration;
    ...
    public Builder applicationConfiguration(Map<String, SteamApplicationConfiguration> applicationConfiguration) { this.applicationConfiguration = applicationConfiguration; return this; }
    ...
    public SteamIdentityProvider build() { return new SteamIdentityProvider(apiMode, buttonText, client_id, scope, webAPIKey, data, applicationConfiguration, attributeMappings, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantConfiguration, tenantId); }
  }
}
