...
import org.lattejava.fusionauth.domain.internal.EpicGamesApplicationConfigurationJSON;

@JSON
public record EpicGamesApplicationConfiguration(
    String buttonText,
    String client_id,
  ...
  public static final class Builder {
    ...
    public EpicGamesApplicationConfiguration build() { return new EpicGamesApplicationConfiguration(buttonText, client_id, client_secret, scope, data, createRegistration); }
  }
}
