...
import org.lattejava.fusionauth.domain.internal.XboxIdentityProviderJSON;

@JSON
@JSONSubtype("Xbox")
public record XboxIdentityProvider(
    String buttonText,
    String client_id,
    String client_secret,
    String scope,
    Map<String, Object> data,
    Map<String, XboxApplicationConfiguration> applicationConfiguration,
  ...
  public static final class Builder {
    ...
    private Map<String, XboxApplicationConfiguration> applicationConfiguration;
    ...
    public Builder applicationConfiguration(Map<String, XboxApplicationConfiguration> applicationConfiguration) { this.applicationConfiguration = applicationConfiguration; return this; }
    ...
    public XboxIdentityProvider build() { return new XboxIdentityProvider(buttonText, client_id, client_secret, scope, data, applicationConfiguration, attributeMappings, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantConfiguration, tenantId); }
  }
}
