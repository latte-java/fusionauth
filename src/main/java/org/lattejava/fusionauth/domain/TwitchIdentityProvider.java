...
import org.lattejava.fusionauth.domain.internal.TwitchIdentityProviderJSON;

@JSON
@JSONSubtype("Twitch")
public record TwitchIdentityProvider(
    String buttonText,
    String client_id,
    String client_secret,
    String scope,
    Map<String, Object> data,
    Map<String, TwitchApplicationConfiguration> applicationConfiguration,
  ...
  public static final class Builder {
    ...
    private Map<String, TwitchApplicationConfiguration> applicationConfiguration;
    ...
    public Builder applicationConfiguration(Map<String, TwitchApplicationConfiguration> applicationConfiguration) { this.applicationConfiguration = applicationConfiguration; return this; }
    ...
    public TwitchIdentityProvider build() { return new TwitchIdentityProvider(buttonText, client_id, client_secret, scope, data, applicationConfiguration, attributeMappings, debug, id, insertInstant, lambdaConfiguration, lastUpdateInstant, linkingStrategy, name, source, tenantConfiguration, tenantId); }
  }
}
