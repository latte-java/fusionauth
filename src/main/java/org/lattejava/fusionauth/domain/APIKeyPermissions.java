...
@JSON
public record APIKeyPermissions(
  ...
  public static final class Builder {
    ...
    public Builder endpoints(Map<String, Object> endpoints) { this.endpoints = endpoints; return this; }
    public APIKeyPermissions build() { return new APIKeyPermissions(endpoints); }
  }
}
