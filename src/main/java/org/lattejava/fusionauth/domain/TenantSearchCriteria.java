...
import org.lattejava.fusionauth.domain.internal.TenantSearchCriteriaJSON;
...
public record TenantSearchCriteria(
  ...
  public static final class Builder {
    ...
    public TenantSearchCriteria build() { return new TenantSearchCriteria(name, numberOfResults, orderBy, startRow); }
  }
}
